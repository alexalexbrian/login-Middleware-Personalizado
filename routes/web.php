...
use App\Http\Controllers\OtrosControllers;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::get('/login/table', [OtrosControllers::class, 'login_table'])->name('login_table');


Route::get('/login/error', [UserControllers::class, 'error_message'])->name('AlexPersonalizedSecurityAlex');
